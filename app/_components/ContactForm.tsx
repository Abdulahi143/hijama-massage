...
<div className="pb-20">
  ...
  <div>
          <h1 className="text-gray-800 text-3xl font-extrabold">Kontakta Oss</h1>
          <p className="text-sm text-gray-500 mt-4">
            Välkommen att boka mina koppnings- och massagebehandlingar. Kontakta mig gärna om du har några frågor eller funderingar.
          </p>
          <div className="mt-12">
            <h2 className="text-gray-800 text-base font-bold">Mejl</h2>
            <ul className="mt-4">
            ...
            >
              <small className="block">Mejl</small>
      ...
      <div className="mt-12">
        <h2 className="text-gray-800 text-base font-bold">sociala medier</h2>
